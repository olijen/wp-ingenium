...
apt-get install -y git php-curl php-cli php-intl php-mysqlnd php-gd php-fpm nginx mysql-server-5.6 php-xdebug
...
ln -f -s /app/vagrant/php5/xdebug.ini /etc/php5/fpm/conf.d/20-xdebug.ini
echo "Done!"
