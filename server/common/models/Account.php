...
class Account extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Customer::className(), ['account_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(IssueMessage::className(), ['account_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Master::className(), ['account_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(ProjectMessage::className(), ['account_id' => 'id']);
    }
